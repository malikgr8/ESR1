# Generated by Django 3.1.7 on 2021-03-08 10:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2021, 3, 8, 15, 27, 41, 190065))),
                ('updated_at', models.DateTimeField(default=datetime.datetime(2021, 3, 8, 15, 27, 41, 190065))),
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='feed.restaurant')),
            ],
        ),
        migrations.AddField(
            model_name='coupon',
