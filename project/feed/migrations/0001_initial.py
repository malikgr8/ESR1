    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Silver'), ('G', 'Gold'), ('D', 'Diamond')], default='S', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=256, null=True, verbose_name='restaurant_address')),
                ('zip_code', models.CharField(blank=True, max_length=10, null=True, verbose_name='restaurant_zip_code')),
                ('lat', models.FloatField(blank=True, null=True, verbose_name='latitude')),
                ('long', models.FloatField(blank=True, null=True, verbose_name='logitude')),
                ...
                ('logo_image', models.ImageField(blank=True, upload_to='', verbose_name='restaurant_logo_image')),
                ('cover_image', models.ImageField(blank=True, upload_to='', verbose_name='restaurant_cover_image')),
                ('menu_image', models.ImageField(blank=True, upload_to='', verbose_name='restaurant_menu_image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_quality', models.IntegerField(validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
                ('rating_money_value', models.IntegerField(validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('offer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='feed.offer')),
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='feed.restaurant')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'unique_together': {('user', 'restaurant', 'offer')},
            },
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('offer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='feed.offer')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
